    ...
    <Form className="m-10">
      <Form.Group className='mb-3 flex flex-col gap-1' controlId='exampleForm.ControlInput1'>
        ...
        <Form.Control className="p-2 border border-gray-800 rounded-md focus:outline-none "
          ...
          value={formData.name} type='name' placeholder='Yor Name'
        />
      </Form.Group>
      <Form.Group className='mb-3 flex flex-col gap-1' controlId='exampleForm.ControlInput1'>
        ...
        <Form.Control className="p-2 border border-gray-800 rounded-md focus:outline-none"
          ...
          value={formData.age} type='number' placeholder='Your Age....'
        />
      </Form.Group>
      <Form.Group className='mb-3 flex flex-col gap-1' controlId='exampleForm.ControlInput1'>
        ...
        <Form.Control className="p-2 border border-gray-800 rounded-md focus:outline-none"
          ...
          value={formData.number} type='text' placeholder='Your Phone Number'
        />
      </Form.Group>
    </Form>
  )
