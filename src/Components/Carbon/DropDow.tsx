...
const DropDow = ({ isDropdownOpen }) => {
  return (
    <div className='ml-80 mt-[-10px]'>
      {isDropdownOpen && (
        <div className='w-44 p-4 rounded-md bg-slate-400 text-white focus:outline-none cursor-pointer'>
          <div className='flex gap-3 items-center'>
            <div className='font-normal text-lg text-white'>Wade Cooper</div>
          ...
          <div className='flex gap-3 items-center'>
            <div className='font-normal text-lg text-white'>Arlene Mccoy</div>
            <span className='relative flex h-3 w-3'>
          ...
          <div className='flex gap-3 items-center'>
            <div className='font-normal text-lg text-white'>Tom Cook</div>
            <span className='relative flex h-3 w-3'>
          ...
          <div className='flex gap-3 items-center'>
            <div className='font-normal text-lg text-white'>Jon Cooks</div>
            <span className='relative flex h-3 w-3'>
